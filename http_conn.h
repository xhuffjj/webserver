...
public:
    ...
    /* 服务器处理HTTP请求的可能结果 */
    enum HTTP_CODE { NO_REQUEST, GET_REQUEST, BAD_REQUEST, NO_RESOURCE, FORBIDDEN_REQUEST, FILE_REQUEST, INTERNAL_ERROR, CLOSED_CONNECTION ,CGI_REQUEST};
    /* 行的读取状态 */
...
private:
    ...
    char* m_string; 
    /*CGI脚本的输出缓冲区*/
    char m_cgi_write_buf[ WRITE_BUFFER_SIZE ];
    /*CGI输出缓冲区的字符数*/
    int m_cgi_write_idx;
